  ...
  <div class="seller" ref='seller'>
    <div class="seller-content">
      <div class="overview">
        ...
        <div class="favorite" @click='favoriteTaggle'>
      ...
      <div class="bulletin">
        ...
        <ul v-if='seller.supports' class='supports'>
          <li class='supports-item border-1px' v-for='item in seller.supports' :key='item.index'>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.$nextTick(this._initPicScroll);
    },
    components: {
      star,
      split
