<template>
  <div class="ratings" ref='ratings'>
    <div class="rating-content">
      ...
      <split></split>
      <ratingselect @updateselectType='updateselectType'  @updateonlyContent='updateonlyContent' :select-type='selectType' :only-content='onlyContent' :desc='desc' :ratings='ratings'></ratingselect>
